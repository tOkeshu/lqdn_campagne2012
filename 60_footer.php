    ...
    <div class="container-wrapper" id="share"><!-- Footer -->
        <div class="container" >
            <div class="row">
                <div class="span8" id="sharelinks">
                    <h2>
       <?php __("Share!"); ?>
                    </h2>
                    <ul>
		      <li>
			<a class="btn-mini" href="https://identi.ca/notice/new?status_textarea=<?php echo urlencode(_("Like me, support @LaQuadrature du Net against #ACTA and beyond!")); ?>"><img src="images/sm_identica.png" /> Identi.ca</a>
			</li>
                        <li>
       <a class="btn-mini" href="http://twitter.com/home?status=<?php echo urlencode(_("Like me, support @LaQuadrature du Net against #ACTA and beyond!")); ?>"><img src="images/sm_twitter.png" /> Twitter</a>
                        </li>
                        <li>
       <a class="btn-mini" href="http://www.facebook.com/sharer.php?url=<?php echo urlencode(ROOTURL); ?>&title=<?php echo urlencode(_("Like me, support La Quadrature du Net against #ACTA and beyond!")); ?>"><img src="images/sm_fb.png" /> Facebook</a>
                        </li>
			<li>
			  <a class="btn-mini" href="http://reddit.com/submit?url=<?php echo urlencode(ROOTURL); ?>&title=<?php echo urlencode(_("Like me, support La Quadrature du Net against #ACTA and beyond!")); ?>"><img src="images/sm_reddit.png" /> Reddit</a>
                        ...
                        <li>
                            <a class="btn-mini" href="mailto:?subject=<?php echo urlencode(_("Support La Quadrature du Net against ACTA and beyond")) ?>&body=<?php echo urlencode(_("For the past four years, La Quadrature du Net has raised awareness and campaigned against ACTA. We need your help to defeat ACTA and move forward, advocating for a positive agenda to protect our freedoms. ")) ?>"><img src="images/sm_mail.png" /> Email</a>
                        </li>
                    </ul>
                </div>
       ...
       <?php __("Spread the message!"); ?>
                    ...
                    <div>
                        <div class="spread">
				<a href="<?php echo ROOTURL; ?>" title="Support La Quadrature du Net against ACTA and beyond!" alt="Support La Quadrature du Net against ACTA and beyond!"><br />
