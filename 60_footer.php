    ...
    <div class="container-wrapper" id="share"><!-- Footer -->
       ...
       <?php __("Share!"); ?>
                    ...
                    <ul>
                        ...
                        <li>
                            <a class="btn-mini" href="mailto:?subject=<?php echo quoted_printable_encode(_("Support La Quadrature du Net against ACTA and beyond")) ?>&body=<?php echo quoted_printable_encode(_("For the past four years, La Quadrature du Net has raised awareness and campaigned against ACTA. We need your help to defeat ACTA and move forward, advocating for a positive agenda to protect our freedoms. ")) ?>">Email</a>
                        </li>
                    </ul>
                </div>
