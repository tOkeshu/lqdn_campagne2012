		   ...
		   <h2><?php __("Frequently Asked Questions"); ?></h2>
			...
			<h4 id="faq-budget"><a href="#faq-budget">Where will my money go?</a></h4>
			...
			<div>
			    ...
			    <br/>You can also support La Quadrature du Net day after day by <a target="_blank" href="http://laquadrature.net/en/how-to-participate">getting involved</a>.
			    ...
			    <br/>Please don't hesitate to <a target="_blank" href="http://www.laquadrature.net/en/contact-us">get in touch</a> to find a way to contribute that suits you!
			</div>
			<h4 id="faq-tax"><a href="#faq-tax">Is my support tax-deductible?</a> </h4>
			<div id="faq5" >
			  Not at the moment. We are looking into a way of making this possible, but unfortunately it is not possible for current donations.
			</div>
			<h4 id="faq-recu"><a href="#faq-recu">I need a receipt or an invoice for my donation.</a> </h4>
			<div id="faq6" > 
			  We can send you a receipt for accounting purposes. Please <a target="_blank" href="http://www.laquadrature.net/en/contact-us">contact us</a> by email.
			</div>
			<h4 id="faq-who"><a href="#faq-who">Who supports La Quadrature du Net?</a></h4>
			<div>
			    Several <a target="_blank" href="http://www.laquadrature.net/en/they-support-la-quadrature-du-net">NGOs support La Quadrature</a>, as well as <a target="_blank" href="http://www.laquadrature.net/en/public-supporters">thousands of individuals who have made a donation</a> and wish to be listed publicly.
			</div>
			...
			<div>
			    ...
			    Send your check to the following address:<br/>
			    <br/><table class="formv"> 
			      <tr><td><i>Payable to: </i></td><td>FDNN</td></tr> 
			      <tr><td><i>Address: </i></td><td>FDNN, 16 rue de Cachy, 80090 Amiens</td></tr> 
			      <tr><td><b>Important note: </b></td><td>Please write down the name you gave us on the back of your check in order to allow us to find you easily.</td></tr> 
			    </table> <br/>
			...
			<br/> 
			  ...
			  <br/>You can also <a target="_blank" href="http://www.laquadrature.net/images/RIB_FDNN.pdf">download the details of FDNN's bank account</a>. 
			...
			<div>We  do not recommend using PayPal for donations, for ethical reasons (their actions against WikiLeaks, among others) and because of the overtly expensive costs incurred. Nevertheless, if it is your only option, you  may use the following account: paypal@laquadrature.net.
			</div>
			<h4 id="faq-flattr"><a href="#faq-flattr">Can I make a donation via Flattr?</a> </h4>
			<div id="faq10" > 
			<br/>Yes! If you wish to support la Quadrature via Flattr, you can simply flatter this page, or any of the site's articles.
...
<a href="http://flattr.com/thing/129120/La-Quadrature-du-Net"><img src="/files/flattr-compact.png" title="Flattr this" alt="Flattr" />
			...
			<h4 id="faq-when-t-shirts"><a href="#faq-when-t-shirts">When will I get my shirt?</a> </h4>
			<div id="faq7" > 
			For logistical reasons, t-shirts are sent in batch. This may take a while, sometimes up to a couple months. Please forgive us for this delay.
			</div>
