		   ...
		   <h2><?php __("Frequently Asked Questions"); ?></h2>
			...
			<div><img src="/images/pichart_en2012.png"/>
			  <p>Forecasted Budget for 2012: 200&nbsp;K &euro;</p>
			</div>
			...
			<div><p>
			    ...
			    You can also support La Quadrature du Net day after day by <a href="http://laquadrature.net/en/how-to-participate">getting involved</a>.
				Financial donations help la Quadrature work on a day-to-day basis by paying for its fulltime activists'  salaries, costs and such, but la Quadrature would be nothing without the people who give their time, skills and energy to support its actions  and make them their own.
				Please don't hesitate to <a href="http://www.laquadrature.net/fr/contact">get in touch</a> to find a way to contribute that suits you!
			</div>
			...
			<div id="faq0" > 
			  ...
			  <b>International bank transfer: </b>IBAN: FR76 1027 8060 3100 0203 2270 187
			...
			<div><p>We  do not recommend using PayPal for donations, for ethical reasons (their actions against WikiLeaks, among others) and because of the overtly expensive costs incurred. Nevertheless, if it is your only option, you  may use the following account: paypal@laquadrature.net.
			  </p>
			</div>
