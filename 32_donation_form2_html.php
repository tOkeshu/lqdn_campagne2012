	     ...
	     <?php } ?>
	       ...
	       <?php if ($_REQUEST["monthly"])  { ?>
		       ...
		       <h3><?php __("Bank information for your monthly donation"); ?></h3>
				...
				<input type="text" id="rib-bq" name="bq" maxlength="5" size="5" style="width: 50px" value="<?php eher("bq"); ?>" title="Code Banque" /> 
				<input type="text" id="rib-gu" name="gu" maxlength="5" size="5"  style="width: 50px" value="<?php eher("gu"); ?>" title="Code Guichet"/> 
				<input type="text" id="rib-cpt" name="cpt" maxlength="11" size="11"  style="width: 110px" value="<?php eher("cpt"); ?>" title="Numéro de compte"/> 
				<input type="text" id="rib-rib" name="rib" maxlength="2" size="2"  style="width: 20px" value="<?php eher("rib"); ?>" title="Clé RIB"/> 
                            </p>
                            <p>
                                <label for="bq_nom"><?php __("Financial Institution's Name:"); ?></label><br /> <input type="text" id="bq_nom" name="bq_nom" size="60" class="largeinput" value="<?php eher("bq_nom"); ?>"/> 
                            </p>
                            <p>
                                <label for="bq_addr"><?php __("Institution's postal address:"); ?></label> <br /><textarea type="text" id="bq_addr" name="bq_addr" ><?php eher("bq_addr"); ?></textarea> 
                            </p>
                            <p>
                                <label for="bq_cp"><?php __("Postal Code:"); ?></label><br /> <input type="text" id="bq_cp" name="bq_cp" size="5" value="<?php eher("bq_cp"); ?>"/> 
                            </p>
                            <p>
                                <label for="bq_ville"><?php __("City:"); ?></label><br /> <input type="text" id="bq_ville" name="bq_ville" size="60" class="largeinput" value="<?php eher("bq_ville"); ?>"/> 
                            </p>
                            <p>
                                <label for="passwd"><?php __("Mot de passe :"); ?></label><br /> <input type="password" id="passwd" name="passwd" size="60" class="largeinput" value="<?php eher("passwd"); ?>"/> 
                            </p>
                            <p>
                                <label for="passwd2"><?php __("De nouveau (vérification) :"); ?></label><br /> <input type="password" id="passwd2" name="passwd2" size="60" class="largeinput" value="<?php eher("passwd2"); ?>"/> 
                            </p>
                        </div>
                    </div>                          
	     <?php } ?>
...
<?php if ($_REQUEST["sum"] >= 100 || ($_REQUEST["sum"] >= 15 && $_REQUEST["monthly"])) { ?>
                    ...
                    <div class="row" id="needcado">
                        <div class="span6">
                            ...
                            <p>
                                <label for="ville"><?php __("Donor's City:"); ?></label><br /> <input type="text" id="ville" name="ville" size="60" class="largeinput" value="<?php eher("ville"); ?>"/> 
                            </p>
                            <p>
                                <label for="pays"><?php __("Donor's Country:"); ?></label><br /> <input type="text" id="pays" name="pays" size="60" class="largeinput" value="<?php eher("pays"); ?>"/> 
                            </p>
                        </div>
                    </div>                          
